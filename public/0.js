...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getCourse: function getCourse() {
      ...
      fetch(Object(_route__WEBPACK_IMPORTED_MODULE_0__["default"])('api.course')).then(function (response) {
        return response.json();
      }).then(function (data) {
        return _this2.courses = data.course;
      });
    }
  } //end methods
  // end export
  ...
  return _c(
    ...
    [
      _c(
        ...
        [
          _c("v-flex", { staticClass: "content" }, [
            _vm.courses
              ? _c("div", { attrs: { color: "white" } }, [
                  _c("h1", [
                    _vm._v("1"),
                    _c("span", { staticClass: "eur" }, [_vm._v(" EUR ")]),
                    _vm._v(": " + _vm._s(_vm.courses) + " "),
                    _c("span", { staticClass: "rub" }, [_vm._v("RUB")])
                  ])
                ])
              : _vm._e()
          ])
...
/*!**********************************!*\
  !*** ./resources/js/routes.json ***!
  \**********************************/
/*! exports provided: , api.course, default */
/***/ (function(module) {

module.exports = {"":"/","api.course":"api/course"};
